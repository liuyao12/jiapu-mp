...
Page({
  ...
  onCommit() {
    ...
    if (!editingId) {
      ...
      this.setData({ showDrawer: false, _pendingEdits: {}, _pendingMotherSelected: false });
    }
  },
  ...
  onCloseDrawer() {
    this.setData({ showDrawer: false, _editingPerson: {}, _pendingEdits: {}, _pendingMotherSelected: false });
  },
  ...
  onDelete() {
    wx.showModal({
      ...
      success: (res) => {
        ...
        this.setData({ db, showDrawer: false });
