...
Page({
  ...
  _buildAiPrompt(target) {
    ...
    const lines = useTraditional ? [
      ...
      '15. events 格式為 [{"name":"皇帝","years":"626-649"}]；年份可以是 "626"、"626-649" 或 "684, 705-710"；不要寫 year、startYear、endYear 或 date。',
      ...
      '15. events 格式为 [{"name":"皇帝","years":"626-649"}]；年份可以是 "626"、"626-649" 或 "684, 705-710"；不要写 year、startYear、endYear 或 date。',
