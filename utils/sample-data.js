const tangImperialSample = require('./sample-tang-imperial.js');
const duguXinSample = require('./sample-dugu-xin.js');
const soongFamilySample = require('./sample-soong-family.js');
